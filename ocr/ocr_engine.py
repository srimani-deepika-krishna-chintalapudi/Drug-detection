...
def image_hash(image_bgr) -> str:
    """Stable cache key for the exact image array."""
...
def make_full_text(boxes, image_shape=None):
    ...
    # Keep vertical text separate so report reading order does not mix MRP/side text
    # with normal horizontal carton text.
